...
void achs(vector<v99>&a,v99 x0,v99 x1, v99 x2)
{
    while(x0--)a.pb(0);
    while(x2--)a.pb(2);
    while(x1--)a.pb(1);
}
v99 los(v99 x0,v99 x1, v99 x2,v99 y0,v99 y1, v99 y2)
{

    v99 m02=min(x0,y2);x0-=m02;y2-=m02;
    v99 m22=min(x2,y2);x2-=m22;y2-=m22;
    v99 m10=min(x1,y0);x1-=m10;y0-=m10;
    v99 m11=min(x1,y1);x1-=m11;y1-=m11;
    v99 m00=min(x0,y0);x0-=m00;y0-=m00;
    v99 m20=min(x2,y0);x2-=m20;y2-=m20;
    v99 m01=min(x0,y1);x0-=m01;y1-=m01;
    v99 m21=min(x2,y1);x2-=m21;y1-=m21;
    v99 m12=min(x1,y2);x1-=m12;y2-=m12;
    return m21*2LL;
}
v99 solve()
{
    /// code is here->
    v99 x0,x1,x2,y0,y1,y2;
    cin>>x0>>x1>>x2>>y0>>y1>>y2;
    v99 loss=los(x0,x1,x2,y0,y1,y2);
    v99 m21=min(x2,y1);x2-=m21;y1-=m21;
    v99 cr_h=m21*2LL;
    v99 m02=min(x0,y2);x0-=m02;y2-=m02;
    v99 m22=min(x2,y2);x2-=m22;y2-=m22;
