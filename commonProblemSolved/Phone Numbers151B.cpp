...
void berkori(vector<string>&vs,v99 a[],string s[],v99 m,v99 n)
{
    rep1(i,1,n)if(a[i]==m)vs.pb(s[i]);
}

void ansberkori(vector<string>vs)
{
    rep0(i,0,vs.size())
    {
        if(i==vs.size()-1)
...
v99 solve()
{
    ...
    berkori(vs,t,s,tm,q);ansberkori(vs);vs.clear();
    cout<<"If you want to order a pizza, you should call: ";
    berkori(vs,p,s,pm,q);ansberkori(vs);vs.clear();
    cout<<"If you want to go to a cafe with a wonderful girl, you should call: ";
    berkori(vs,g,s,gm,q);ansberkori(vs);
}
