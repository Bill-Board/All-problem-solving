...
v99 berkori(v99 &c,v99 cnt,v99 wgt)
{
    v99 kot=cnt*wgt;
    if(kot<=c)
    {
...
{
    /// code is here->
    v99 c1,c2;cin>>c1>>c2;c1+=c2;
    v99 tct,twg,kct,kwg;cin>>tct>>kct>>twg>>kwg;
    v99 cr_h=0;
    if(twg<=kwg)cr_h+=berkori(c1,tct,twg)+berkori(c1,kct,kwg);
    else cr_h+=berkori(c1,kct,kwg)+berkori(c1,tct,twg);
    cout<<cr_h<<ses;
}
