...
void solve()
{
    ...
    v99 n,cr_h=0;cin>>n;
    v99 a[n+1][n+1]={};
    rep1(i,1,n)rep1(j,1,n){char c;cin>>c;if(c=='1')a[i][j]=1;}
    if(a[1][2] == a[2][1])
    {
        if(a[1][2]==1)
        {
            ...
            {
                if(a[n][n-1])cout<<1<<ses<<n<<whp<<n-1<<ses;
                else cout<<1<<ses<<n-1<<whp<<n<<ses;
            }
        }
        else
        {
        ...
        if(a[n][n-1] == a[n-1][n])
            {
                if(a[n][n-1]==1)
                    {
                        if(a[1][2])cout<<1<<ses<<"1 2"<<ses;
                        else cout<<1<<ses<<"2 1"<<ses;
                    }
                else
                    {
                        if(!a[1][2])cout<<1<<ses<<"1 2"<<ses;
            ...
            {
                cout<<2<<ses;
                if(!a[1][2])cout<<"1 2"<<ses;
                else cout<<"2 1"<<ses;
                if(a[n][n-1])cout<<n<<whp<<n-1<<ses;
                else cout<<n-1<<whp<<n<<ses;
            }
    }
}
