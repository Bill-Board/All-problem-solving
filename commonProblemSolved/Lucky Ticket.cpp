...
int main()
{
    ...
    //while(1)
    {
        v99 n;cin>>n;string s;cin>>s;
        v99 f1=0,s1=0,s2=0,f2=0;
        rep0(i,0,n/2){if(s[i]=='4')f1++;else if(s[i]=='7')s1++;}
        rep0(i,n/2,n){if(s[i]=='4')f2++;else if(s[i]=='7')s2++;}
        if(f1==f2 && s1==s2 && f1+f2+s1+s2==n)cout<<"YES"<<ses;
        else cout<<"NO"<<ses;
    }
    return 0;
}
