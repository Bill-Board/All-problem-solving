...
{
    /// code is here->
    string s[]={"December","January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November"};
    string s1[]={"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November","December"};
    map<string,v99>mpp;v99 j=1;
    for(auto i:s1)mpp[i]=j++;
    v99 n;string p;cin>>p>>n;
    v99 kot=n+mpp[p];
    cout<<s[kot%12]<<ses;
}
