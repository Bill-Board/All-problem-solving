...
int main()
{
    ...
    //while(1)
    {
        cin>>n;v99 a[n+1],visi[n+2];CLR(visi,0);
        map<v99,v99>mpp;
        rep1(i,1,n)
        {
            cin>>a[i];
        ...
        if(mpp[1]==0)cout<<"First"<<ses;
        else if(mpp[1]==n)
        {
            if(n&1)cout<<"First"<<ses;
            else cout<<"Second"<<ses;
        }
        else
        {
            v99 i=1;
            while(a[i]==1)i++;
            if(i&1)cout<<"First"<<ses;
            else cout<<"Second"<<ses;
        }
    }
    return 0;
      ...
      /**  Alhamdulillah...for(v99 i=n-1;i>0;i--){if(visi[i-1]&&visi[i])visi[i-1]+=visi[i];}visi[n]=0;
            ...
            while(i<n)
            {
                ...
                {
                    if(visi[i+1]&1)cout<<i<<whp<<visi[i+1]<<ses,i++;
                    else a[i]=1;
                }
                else a[i]=1;
                cout<<cr_h<<ses;
