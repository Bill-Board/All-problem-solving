...
///-------------------------------------------------------------------------------------------------------
v99 accha(v99 pos,v99 a[],v99 x,v99 n)
{
    v99 cr_h=0;
    rep0(i,pos,n)
        {
...
int main()
{
    ...
    //while(1)
    {
        ...
        rep0(i,0,n)cin>>a[i];sort(a,a+n);//reverse(a,a+n);
        auto it=lower_bound(a,a+n,x);v99 pos=it-a;
        cr_h=accha(pos,a,x,n);
        if(pos!=0)cr_h=min(cr_h,accha(pos-1,a,x,n));
        cout<<cr_h<<ses;
    }
    return 0;
}
