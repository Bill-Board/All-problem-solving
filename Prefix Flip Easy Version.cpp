...
string change(string s,v99 ind)
{
    string p="";
    rep1(i,1,ind)p+=(s[i]=='1'?'0':'1');
...
int main()
{
    ...
    //while(1)
    {
        v99 n;cin>>n;string a,b;cin>>a>>b;a='+'+a;b='+'+b;
        vector<v99>k;
        for(v99 i=n;i>0;i--)
        {
            if(a[i]!=b[i])
            {
                if(a[1]==b[i])a[1]=(a[1]=='1'?'0':'1'),k.push_back(1);
                string p="+"+change(a,i);
                k.push_back(i);
                rep1(j,1,i)a[j]=p[j];
            }
