...
///-------------------------------------------------------------------------------------------------------
string s;
v99 age_jdi_partam(v99 l,v99 r,char c)
{
    if(l==r)return s[l]!=c;
    v99 kot=0;
    for(v99 i=l;i<=(l+r)/2;i++)if(s[i]!=c)kot++;
    v99 ek=age_jdi_partam((l+r)/2 +1,r,c+1);
    v99 kot2=0;
    for(v99 i=(l+r)/2 +1;i<=r;i++)if(s[i]!=c)kot2++;
    v99 dui=age_jdi_partam(l,(l+r)/2,c+1);
    return min(kot+ek,kot2+dui);
}
...
int main()
{
    ...
    {
        v99 n;cin>>n>>s;
        cout<<age_jdi_partam(0,n-1,'a')<<ses;
    }
    return 0;
}
