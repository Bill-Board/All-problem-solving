...
void solve()
{
    /// code is here->
    v99 n;cin>>n;
    if(n<31){cout<<"NO"<<ses;return;}
    if(n-30==6)cout<<"YES"<<ses<<"6 10 15 5"<<ses;
    else if(n-30==14)cout<<"YES"<<ses<<"6 10 21 7"<<ses;
    else if(n-30==10)cout<<"YES"<<ses<<"6 10 15 9"<<ses;
    else cout<<"YES"<<ses<<"6 10 14 "<<n-30<<ses;
}
