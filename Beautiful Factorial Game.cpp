...
void solve(v99 tc)
{
    /// code is here-> https://ideone.com/Go129v
    ///   https://ideone.com/nO0hWA
    v99 n,k,cr_h=LLONG_MAX;cin>>n;cin>>k;
    map<v99,v99>mpp=berkori(k);
    for(auto i:mpp)
    {
        v99 p=i.ff,kot=i.ss;
        v99 acha=ans(n,p)/kot;
        cr_h=min(cr_h,acha);
    }
    //printf("Case %lld: %lld\n",tc,cr_h);
    printf("%lld\n",cr_h);
